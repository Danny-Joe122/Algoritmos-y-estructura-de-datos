...
public class LinkedBST<E extends Comparable<E>> implements BinarySearchTree<E> {
    ...
    // Insertar elemento en BST con excepción ItemDuplicated
    @Override
    ...
    // Eliminar elemento del BST con excepciones
    @Override
    ...
    // Contar nodos no hoja (con hijos)
    @Override
    ...
    // Altura del subárbol con raíz dato x (iterativo)
    @Override
    ...
    // Amplitud o anchura en nivel dado
    @Override
    ...
    // Dibujar el árbol con sangrías (usando toString)
    @Override
    public void drawBST() {
        System.out.println(parenthesize(root, 0));
    }

    private String parenthesize(Node node, int indent) {
        if (node == null) return "";
        StringBuilder sb = new StringBuilder();
        for (int i = 0; i < indent; i++) sb.append("  ");
        sb.append(node.data).append("\n");
        sb.append(parenthesize(node.left, indent + 1));
        sb.append(parenthesize(node.right, indent + 1));
        return sb.toString();
    }

    // Comparar área con otro árbol
    @Override
    public boolean sameArea(BinarySearchTree<E> other) throws ExceptionIsEmpty {
        if (this.root == null || other == null) throw new ExceptionIsEmpty("Árbol vacío");
    ...
    // Representación parenthesize con sangría y paréntesis
    @Override
